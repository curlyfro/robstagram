...
export class RobstagramService {
     ...
     */
    deletePost(id: number): Observable<string | null> {
    ...
    protected processDeletePost(response: HttpResponseBase): Observable<string | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    deleteComment(id: number): Observable<PostData | null> {
        let url_ = this.baseUrl + "/api/Robstagram/comments/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeleteComment(response: HttpResponseBase): Observable<PostData | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
